...
class Bancoob extends AbstractRemessa implements RemessaContract
{
    ...
    protected $codigoBanco = PagamentoContract::COD_BANCO_BANCOOB;
    ...
    public function segmentoB( $nSequencialLote, PagamentoContract $pagamento )
    {
        ...
        $this->add( 63, 67, Util::formatCnab( 'X', $pagamento->getFavorecido()
                                                             ->getNumero(), 5 ) ); // Endereço do pagador/Sacado
        $this->add( 68, 82, Util::formatCnab( 'X', $pagamento->getFavorecido()
                                                             ->getComplemento(), 5 ) ); // Endereço do pagador/Sacado
        ...
        $this->add( 211, 225, Util::formatCnab( 9, Util::onlyNumbers( $pagamento->getFavorecido()
                                                                                ->getDocumento() ), 15 ) ); // Tipo de inscrição do sacado
    ...
    protected function headerLote()
    {
        ...
        $this->add( 14, 16, Util::formatCnab( '9', 45, 3 ) ); // Versão do layout
