...
abstract class AbstractPagamento implements PagamentoContract
{
     ...
     * @var array
     */
    private $camposObrigatorios = ['bancoFavorecido', 'agenciaFavorecido', 'contaFavorecido', 'contaDvFavorecido',];

    protected $protectedFields = ['nossoNumero',];
    ...
    public function setPixTipo( $pixTipo )
    {
