...
## Bancos suportados
 ...
 Banco                 |         Homologado         |            PIX             |            TED             | Transferências entre contas |
-----------------------|:--------------------------:|:--------------------------:|:--------------------------:|:----------------------------:|
 Sicredi - Manual V3.4 |     :white_check_mark:     |     :white_check_mark:     |     :white_check_mark:     |      :white_check_mark:      |
 Bancoob (Sicoob)      | :eight_pointed_black_star: | :eight_pointed_black_star: | :eight_pointed_black_star: |  :eight_pointed_black_star:  |
